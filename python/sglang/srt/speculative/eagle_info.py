...
class EagleVerifyInput(SpecInput, EagleVerifyInputV2Mixin):
    ...
    def prepare_for_verify(self, batch: ScheduleBatch, page_size: int):
        ...
        if page_size == 1:
            ...
            from sglang.srt.hardware_backend.npu.dsv4_common_hooks import (
                compute_dsv4_verify_state_lens,
                maybe_write_dsv4_verify_extend,
            )

            dsv4_state_lens = compute_dsv4_verify_state_lens(
                batch, prefix_lens_cpu.tolist(), self.draft_token_num
            )
            ...
            maybe_write_dsv4_verify_extend(batch, prefix_lens_cpu, end_offset_cpu)
    ...
    def verify(
        ...
        from sglang.srt.hardware_backend.npu.dsv4_common_hooks import (
            recycle_dsv4_verify_rejected_pages,
        )

        recycle_dsv4_verify_rejected_pages(
            batch, _dsv4_accept_lens, self.draft_token_num
        )
