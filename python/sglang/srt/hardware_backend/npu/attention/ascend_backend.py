...
class AscendAttnMultiStepDraftBackend:
    ...
    def __init__(
        ...
        self.is_dsv4 = is_deepseek_v4(model_runner.model_config.hf_config)
        if self.is_dsv4:
    ...
    def _step_out_cache_loc_dsv4(self, forward_batch: ForwardBatch, step_id: int):
        ...
        if step_width == 0 or raw_total_width < total_width:
            return bundle

        raw_bs = step_width // self.topk

        def split_by_step(loc):
        ...
        def split_compress(loc, ratio: int):
        ...
        return DSV4OutCacheLoc(
            out_full_loc=split_by_step(bundle.out_full_loc),
            out_swa_loc=split_by_step(bundle.out_swa_loc),
            out_c4_loc=split_compress(bundle.out_c4_loc, 4),
            out_c128_loc=split_compress(bundle.out_c128_loc, 128),
            out_c4_state_loc=split_by_step(bundle.out_c4_state_loc),
            out_c128_state_loc=split_by_step(bundle.out_c128_state_loc),
        )
    ...
    def init_forward_metadata_replay_cuda_graph(
        ...
        def call_fn(i, forward_batch):
            ...
            if self.is_dsv4:
                ...
                if step_bundle is not None and step_bundle.out_full_loc is not None:
